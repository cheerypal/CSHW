...
<head>
    ...
    <script src="AJAXPresentYear.js" type="text/javascript"></script>
    <script src="AJAXFindMyYear.js" type="text/javascript"></script>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="nav navbar-nav text-center navbar-right">
                ...
                <li class="active"><a href="http://www2.macs.hw.ac.uk/~ejg9/CSHW/MyYear/">My Year</a></li>
...
<section>
    <div id="pre" class="jumbotron text-center" style="padding-top: 115px; padding-bottom: 70px; margin-bottom:0;">
        <h1>Year <?=$yearOfStudy?> Forum Page</h1>
    </div>
    <div id="Main">
        <div class="container">
            <div id="mainRow" class="row">
                ...
                <div class="columns column-Recent col-sm-8">
                    <h2 style="padding-top:0; margin-top:0; font-weight: bold">Recent Year <?=$yearOfStudy?> Posts</h2>
                    <div id="items">
                        <div id="posts">
                            <!--posts-->
                        </div>
